...
- **weather**: Get current weather and pollen info. Use when asked about weather, temperature, pollen, allergies, or "what's it like outside".
...
- When asked about weather, temperature, or pollen, use **weather**.
...
- Only use **reply** for casual conversation that genuinely has nothing to do with movies, shows, weather, or media.
