...
- **reply**: Just send a message. No API calls to the media server needed. Use sparingly — only for clearly conversational messages (greetings, thanks, memory questions). If a message could plausibly be a title, prefer **search** instead.
